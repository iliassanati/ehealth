...
class RecentlyRdv extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      anchorEl: null
  ...
  render() {
    ...
    return (
      <Paper>
        <List
          subheader={
            <ListSubheader classes={{ root: classes.subheader }}>Recent Rdvs</ListSubheader>
          }
        >
          {rdvs && rdvs.map((rdv) => (
            <ListItem key={rdv._id}>
              ...
              <ListItemText primary={rdv.userNom} secondary={rdv.doctorNom} />
...
RecentlyRdv.propTypes = {
  rdvs: PropTypes.array,
  classes: PropTypes.object
};

export default withStyles(styles)(RecentlyRdv);
