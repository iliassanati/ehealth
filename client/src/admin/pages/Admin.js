...
import AdminScreen from './User/AdminScreen'
...
import DrTable from "./Dr/DrTable";
import RdvTable from "./Rdv/RdvTable";
import PaymentTable from "./Payement/PaymentTable";
      ...
      <ThemeProvider theme={theme}>
        ...
        <div className={classNames(classes.container, !navDrawerOpen && classes.containerFull)}>
          <Switch>
            ...
            <Route path="/admin/admin" component={AdminScreen} />
            ...
            <Route path="/admin/table/dr" component={DrTable} />
            <Route path="/admin/table/rdv" component={RdvTable} />
            <Route path="/admin/table/payement" component={PaymentTable} />
